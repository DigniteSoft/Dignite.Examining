...
namespace Dignite.Examining
{
    [DependsOn(
        ...
        typeof(Abp.SettingManagement.DigniteAbpSettingManagementHttpApiModule),
        typeof(Abp.SettingManagement.DigniteAbpSettingManagementApplicationModule)
        )]
